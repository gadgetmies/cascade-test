...
function getFixturePath(
  ...
  // Security check: ensure fixtureName doesn't escape the fixtures directory
  if (!isPathSafe(fixtureName, fixtureDir)) {
    throw new Error(`Security Error: Fixture name '${fixtureName}' is outside the fixtures directory.`);
  }
